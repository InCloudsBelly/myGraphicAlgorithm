...
struct IMGUI_API ImDrawListSharedData
{
    ...
    _mFont*         Font;                       // Current/default font (optional, for simplified AddText overload)
...
struct ImGuiContext
{
    ...
    _mGuiIO                 IO;
    ImGuiStyle              Style;
    _mFont*                 Font;                               // (Shortcut) == FontStack.empty() ? IO.Font : FontStack.back()
    ...
    ImVector<_mFont*>       FontStack;                          // Stack for PushFont()/PopFont()
...
namespace ImGui
{
    ...
    IMGUI_API void          SetCurrentFont(_mFont* font);
    inline _mFont*          GetDefaultFont() { ImGuiContext& g = *GImGui; return g.IO.FontDefault ? g.IO.FontDefault : g.IO.Fonts->Fonts[0]; }
...
IMGUI_API void              ImFontAtlasBuildSetupFont(ImFontAtlas* atlas, _mFont* font, ImFontConfig* font_config, float ascent, float descent);
