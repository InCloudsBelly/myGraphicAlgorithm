...
int main()
{
	...
	MyGraphics::ResourceManager::registerRenderPass(std::make_shared<_SkyboxPass>("SkyboxPass", 1));
	MyGraphics::ResourceManager::registerRenderPass(std::make_shared<_ShadingPass>("ShadingPass", 2));
