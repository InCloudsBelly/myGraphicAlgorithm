...
{	
    ...
    Basis[2] = 2.0 / 3.0 * sqrt(3.f / (4.f * PI)) * (z);
    Basis[3] = 2.0 / 3.0 * sqrt(3.f / (4.f * PI)) * (-y);
    Basis[4] = 1.0 / 4.0 * 1.f / 2.f * sqrt(15.f / PI) * x * y;
    Basis[5] = 1.0 / 4.0 * 1.f / 2.f * sqrt(15.f / PI) * (- z * y);
    Basis[6] = 1.0 / 4.0 * 1.f / 4.f * sqrt(5.f / PI) * (3 * z2 -1);
    Basis[7] = 1.0 / 4.0 * 1.f / 2.f * sqrt(15.f / PI) * (- x * z);
    Basis[8] = 1.0 / 4.0 * 1.f / 4.f * sqrt(15.f / PI) * (x2 - y2);
