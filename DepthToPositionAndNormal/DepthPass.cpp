...
_DepthPass::_DepthPass(const std::string& vPassName, int vExcutionOrder) :_RenderPass(vPassName, vExcutionOrder)
{
}

_DepthPass::~_DepthPass()
{
}

//************************************************************************************
//Function:
void _DepthPass::initV()
{
	MyGraphics::Camera::setMainCameraPos({ 0, 0.615485, 3 });
	MyGraphics::Camera::setMainCameraFront({ -0.0594117, -0.15902, -0.985486 });
