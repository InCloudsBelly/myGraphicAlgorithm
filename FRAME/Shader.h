...
class FRAME_DLLEXPORTS _Shader
{
public:
	_Shader() = default;
	_Shader(const std::string& vVertexShaderFileName, const std::string& vFragmentShaderFileName, const std::string& vGeometryShaderFileName = "",
		const std::string& vTessellationControlShaderFileName = "", const std::string& vTessellationEvaluationShaderFileName = "");
	_Shader(const std::string& vComputeShaderFileName);
	~_Shader();
	...
	GLvoid setTextureUniformValue(const std::string& vTextureUniformName, const std::shared_ptr<MyGraphics::STexture>& vioTextureConfig);
	GLvoid setImageUniformValue(const std::shared_ptr<MyGraphics::STexture>& vTextureConfig);
	...
	//GLvoid changeImageUniformValue(const MyGraphics::STexture& vTextureCongfig);
...
private:
	...
	std::map<std::string, std::tuple<int, std::shared_ptr<MyGraphics::STexture>>> m_TextureUniformNameAndBindUnitAndTC;
	std::set<std::shared_ptr<MyGraphics::STexture>> m_BindingImageTextureSet;
