...
{
	//1
	auto Texture1 = std::make_shared<MyGraphics::STexture>();
	...
	Texture1->TextureType = MyGraphics::STexture::ETextureType::TextureCubeMap;
	...
	//2
	auto Texture2 = std::make_shared<MyGraphics::STexture>();
	...
	Texture2->TextureType = MyGraphics::STexture::ETextureType::TextureCubeMap;
	...
	//3
	auto Texture3 = std::make_shared<MyGraphics::STexture>();
	...
	Texture3->TextureType = MyGraphics::STexture::ETextureType::TextureCubeMap;
