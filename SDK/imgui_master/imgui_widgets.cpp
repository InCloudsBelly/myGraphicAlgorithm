...
bool ImGui::InputTextEx(const char* label, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (is_password)
    {
        ...
        _mFont* password_font = &g.InputTextPasswordFont;
    ...
    // without any carriage return, which would makes _mFont::RenderText() reserve too many vertices and probably crash. Avoid it altogether.
