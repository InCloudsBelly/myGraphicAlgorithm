...
void main()
{
	...
	vec3 RandianceIntensity = u_LightColor * TexelColor / u_VPLsCount * u_RSMCameraAreaInWorldSpace;/** max(dot(Normal, -LightDirInViewSpace), 0)*/	//先把VPLs总数除了，按照作者的说法，不应该乘这个余弦值
