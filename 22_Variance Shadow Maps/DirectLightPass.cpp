...
void _DirectLightPass::initV()
{
	...
	auto BlurLightDepthTexture = MyGraphics::ResourceManager::getSharedDataByName<std::shared_ptr<MyGraphics::STexture>>("BlurLightDepthTexture");
	...
	m_pShader->setTextureUniformValue("u_BlurLightDepthTexture", BlurLightDepthTexture);
	...
	m_pShader->setFloatUniformValue("m_CameraSizeExtent", MyGraphics::ResourceManager::getSharedDataByName<float>("m_CameraSizeExtent") * MyGraphics::ResourceManager::getSharedDataByName<float>("m_CameraSizeExtent"));
	m_LightDir = MyGraphics::ResourceManager::getSharedDataByName<glm::vec3>("LightDir");	
	auto LightColor = MyGraphics::ResourceManager::getSharedDataByName<glm::vec3>("LightColor");	
